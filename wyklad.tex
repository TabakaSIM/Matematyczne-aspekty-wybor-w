...
\end{definition}
	...
	\begin{zad}
		Metoda Bolińskiego-Yonga - metoda wartościująca w sposób rekurencyjny\\
		
		Mamy dane wkłady akcjonariuszy $p_1,\dots,p_s$\\
		
		\begin{enumerate}[1.]
			\item Zakładamy warunek początkowy $n=0$, $a_1=a_2=\cdot=a_s=0$
			...
			$$~ 1+a_i > \lceil q_i \rceil = \lceil \frac{(m+1)p_i}{p}\rceil$$ 
		\end{enumerate}
	
	Wyznacz jak należało by rodzielić pierwsze 8 (12) akcji.
	\end{zad}

	Czyli uzupełnij tabelkę (zwróć szczególną uwagę na wiersz 7 i 11):\\\\
	
	\begin{center}
		\begin{tabular}{||c||c||c|c|c||c|c|c||c|c|c||}\hline
		&\Large$w$&\Large$q_1$&\Large$q_2$&\Large$q_3$&\Large$\frac{p_1}{1+a_1}$&\Large$\frac{p_2}{1+a_2}$&\Large$\frac{p_3}{1+a_3}$&\Large$a_1$&\Large$a_2$&\Large$a_3$\\\hline
	...
	\begin{zad}
		Wykaż, że nie może zaistnieć sytuacja, że wszystkie wartości potencjalne akcjonariuszy przekraczają górną quotę.
	\end{zad}

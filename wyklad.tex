...
\end{definition}
	...
	$X\setminus B \in F \Rightarrow X\subset B \in G$ $B TODO set iloczyn (X\setminus B)$ sprzeczność.
	...
	$C set iloczyn (X\setminus C)=\emptyset \in F$ sprzeczność
	...
	$X\setminus\{p_1\} iloczyn X\setminus\{p_1\} \dots X\setminus\{p_1\} = \emptyset \notin F$ sprz
	\begin{flushright}$\square$\end{flushright}
